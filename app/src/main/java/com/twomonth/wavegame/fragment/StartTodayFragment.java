...
import com.twomonth.wavegame.activity.HomeActivity;
...
public class StartTodayFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_starttody;
    }

    @Override
    protected void initView() {
        recyclerView = mContentView.findViewById(R.id.recycle_start_today);
